...
import solar from "../assets/3D PRINTING/IMG_20220519_092642.jpg";
import printing from "../assets/PRESENTATION/WhatsApp Image 2025-03-03 at 20.27.11 (1).jpeg";
import graphics from "../assets/RENEWABLE ENERGY GEN PROJECT & ELECTRIC MOBILITY/WhatsApp Image 2025-03-03 at 20.32.25 (1).jpeg";
import main from "../assets/PRESENTATION/WhatsApp Image 2025-03-24 at 12.49.27_4930bad5.jpg";

const images = [solar, graphics, printing];
    ...
    <div className="home">
      ...
      <section className="introduction">
        <div className="intro-text">
          <p>
            Mega G Techniques is a cutting-edge 3D printing and Renewable energy
            niche company dedicated to transforming ideas into tangible
            products. Our mission is simply to deliver innovative, high-quality,
            and customizable 3D printable solutions integrated with electronics
            and heavy current products (Renewable energy) to produce
            extraordinary functional solutions.
          </p>
          <p>
            We do multi-skills service and product delivery such as Electricity
            installations (House wiring) and repairs, 3D graphics design, and
            Printing. We house skills such as electrical and Mechanical
            Engineering, 3D graphics design, 3D printing, and Renewable energy
            technology.
          </p>
        </div>
